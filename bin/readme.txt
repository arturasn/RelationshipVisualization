This is the README file for the RelationshipVisualizationionalization sample for wxWidgets.
...
A. First of all, you will need the GNU gettext tools (see the next questions).
   ...
   xgettext -C -n -k_ -kwxPLURAL:1,2 -kwxTRANSLATE -o RelationshipVisualization.po ../RelationshipVisualization.cpp
   ...
   vi RelationshipVisualization.po wxstd.pot

   # create the message catalog files
   msgfmt -o RelationshipVisualization.mo RelationshipVisualization.po
   msgfmt -o wxstd.mo wxstd.pot

   # run the sample to test it
   cd ..
   ./RelationshipVisualization <language>

Q. How to do update the translation of 'RelationshipVisualization' sample for a language?
A. First of all, you will need the GNU gettext tools (see the next question).
   ...
   xgettext -j -C -n -k_ -kwxPLURAL:1,2 -kwxTRANSLATE -o RelationshipVisualization.po ../RelationshipVisualization.cpp

   # now edit the files and do translate the new strings (this isn't done by gettext)
   vi RelationshipVisualization.po
...
Q. What's i18n?
A. Count the number of letters in the word "RelationshipVisualizationionalization".
